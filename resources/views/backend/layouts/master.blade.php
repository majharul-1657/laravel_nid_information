...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        @if (auth()->user())
        <div class="image">
          <img src="{{asset('storage/upload/user_photo/'.auth()->user()->photo)}}" height="200px" width="200" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
    ...
    @include('backend.layouts.sidemanu')
    </div>
    <!-- /.sidebar -->
  </aside>
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer pl-5">
    <strong>Copyright:majharul islam &copy; 2022-2023 </strong>
    All rights reserved.
