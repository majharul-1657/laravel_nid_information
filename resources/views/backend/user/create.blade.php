      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card mt-3">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" id="myForm" action="{{ route('backend.user.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                  <div class="card-body">
                        <div class="row">
                          <div class="col-md-6">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control" id="cPassword" name="cPassword" placeholder="Enter conform password">
                              @error('cPassword')
                                  <font style="color: red">{{ $message }}</font>
                              @enderror
                            </div>
