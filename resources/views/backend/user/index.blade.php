            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header">
                      <h3>All user
                          <a class="btn btn-primary float-right btn-sm" href="{{ route('backend.user.create') }}">Add user</a>
                      </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning btn-sm" href="{{ route('backend.user.edit', $data->id) }}"><i class="fa fa-edit"></i></a>
                                    <a class="btn btn-danger btn-sm delete" href="{{ route('backend.user.delete', $data->id) }}"><i class="fa fa-trash"></i></a>
                                </td>
                              </tr>
                            @endforeach
                        </tbody>
